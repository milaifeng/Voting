    ...
    <section className="py-12 px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
        <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">总投票数</p>
        </div>
        <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg text-center">
          <p className="text-4xl font-bold text-green-600">
            <CountUp end={activePolls} duration={2.5} />
          </p>
          <p className="text-gray-600 dark:text-gray-300">活跃提案</p>
        </div>
        <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg text-center">
          <p className="text-4xl font-bold text-purple-600">
            <CountUp end={users} duration={2.5} />
          </p>
          <p className="text-gray-600 dark:text-gray-300">社区用户</p>
        </div>
        <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg text-center">
          <p className="text-4xl font-bold text-yellow-600">{topReward}</p>
          <p className="text-gray-600 dark:text-gray-300">本周冠军奖励</p>
        </div>
      </div>
    </section>
  );
